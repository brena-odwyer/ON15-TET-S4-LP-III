...
function buscarFilmes(entrada) {
    if (typeof(entrada) == "string") {
        ...
        if(porTitulo.length > 0 && porGenero.lenght > 0)
...
//profa, você pode dar uma lida nos arquivos 5.1desafio.js e 5.2desafio.js? Foram minhas tentativas de fazer o exercício antes de fazermos juntas na quarta, só para você ver minha lógica (até porque não tava funcionando rsrsrs). Se for possível, claro, se não, tudo bem.